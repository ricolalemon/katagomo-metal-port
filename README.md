...
> This repository is a personal forward-port of KataGomo's Gomoku-specific logic onto KataGo v1.16.4, with an Apple Silicon Metal build path and a macOS 15 release package flow.
>
> It is not an official KataGo or KataGomo release.

## Gomoku Metal Port

If you are here for the Gomoku/Metal work rather than upstream KataGo itself, start with:

* [Gomoku Metal Port Overview, build steps, and known limitations](docs/GomokuMetalPort.md)
* [Benchmark and regression summary](docs/GomokuMetalBenchmarks.md)
* [macOS 15 Metal packaging script](misc/package_macos15_metal.sh)
* [Sample Gomoku release config](cpp/configs/gomoku_freestyle_metal_release.cfg)
